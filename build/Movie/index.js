          ...
          "children": [
            {
              ...
              "shown": function () {return this.detail.id},
              "children": [
                {
                  "type": "div",
                  "attr": {},
                  "children": [
                    {
                      "type": "rate",
                      "attr": {
                        "rate": function () {return this.detail.ratings_count?this.detail.rating.average:''}
                      }
                    },
                    {
                      "type": "text",
                      "attr": {
                        "value": function () {return (this.detail.comments_count) + '人评价'}
                      },
                      "classList": [
                        "remark"
                      ]
                  ...
                  "children": [
                    {
                      "type": "text",
                      "attr": {
                        "value": function () {return (this.detail.year) + ' ' + (this.detail.genres&&this.detail.genres.join(' /'))}
                      }
                    },
                    {
                      "type": "text",
                      ...
                      "children": [
                        ...
                        },
                        {
                          "type": "span",
                          "attr": {
                            "value": function () {return this.detail.original_title}
                          }
                        }
                      ]
                    },
                    {
                      ...
                      "children": [
                        ...
                        },
                        {
                          "type": "span",
                          "attr": {
                            "value": function () {return this.detail.countries&&this.detail.countries.join('/')}
                          }
                        }
                      ]
                    },
                    {
                      ...
                      "children": [
                        ...
                        },
                        {
                          "type": "span",
                          "attr": {
                            "value": function () {return this.detail.aka&&this.detail.aka.join('/')}
                          }
                        }
                      ]
                    }
            ...
            },
            {
              "type": "image",
              "attr": {
                "src": function () {return this.detail.images&&this.detail.images.small}
              },
              "classList": [
                "cover"
              ]
              ...
              "children": [
                {
                  ...
                  "repeat": function () {return this.detail.directors},
                  "children": [
                    {
                      "type": "div",
                      "attr": {},
                      ...
                      "children": [
                        {
                          "type": "image",
                          "attr": {
                            "src": function () {return this.$item.avatars.small}
                          },
                          "classList": [
                            "actor"
                          ]
                ...
                },
                {
                  ...
                  "repeat": function () {return this.detail.casts},
                  "children": [
                    {
                      "type": "div",
                      "attr": {},
                      ...
                      "children": [
                        {
                          "type": "image",
                          "attr": {
                            "src": function () {return this.$item.avatars&&this.$item.avatars.small}
                          },
                          "classList": [
                            "actor"
                          ]
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return network.get('/v2/movie/subject/' + (this.id || '30183442'));
